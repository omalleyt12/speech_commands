...
train_writer = tf.summary.FileWriter("logs/train_unknown_driveconv1_tom1d2",sess.graph)
val_writer = tf.summary.FileWriter("logs/val_unknown_driveconv1_tom1d2",sess.graph)
