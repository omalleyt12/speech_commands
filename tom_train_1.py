...
train_writer = tf.summary.FileWriter("logs/train_unknown_mfcc_vggnetlite_biggerFC",sess.graph)
val_writer = tf.summary.FileWriter("logs/val_unknown_mfcc_vggnetlite_biggerFC",sess.graph)
