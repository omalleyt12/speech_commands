...
train_writer = tf.summary.FileWriter("logs/train_unknown_overdrive_full_bn_loud_noise",sess.graph)
val_writer = tf.summary.FileWriter("logs/val_unknown_overdrive_full_bn_loud_noise",sess.graph)
